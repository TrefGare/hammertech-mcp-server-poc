...
export class HammerTechMCPServer {
  ...
  private apiClient: HammerTechApiClient | null = null;
  ...
  // Tool handlers
  private async handleListProjects(args: any): Promise<CallToolResult> {
  ...
  private async handleGetProject(args: any): Promise<CallToolResult> {
  ...
  private async handleListWorkers(args: any): Promise<CallToolResult> {
  ...
  private async handleGetWorker(args: any): Promise<CallToolResult> {
  ...
  private async handleListWorkerProfiles(args: any): Promise<CallToolResult> {
  ...
  private async handleGetWorkerProfile(args: any): Promise<CallToolResult> {
  ...
  private async handleCreateWorkerProfile(args: any): Promise<CallToolResult> {
  ...
  private async handleUpdateWorkerProfile(args: any): Promise<CallToolResult> {
  ...
  private async handleListEmployers(args: any): Promise<CallToolResult> {
  ...
  private async handleGetEmployer(args: any): Promise<CallToolResult> {
  ...
  private async handleCreateEmployer(args: any): Promise<CallToolResult> {
  ...
  private async handleListEmployerProfiles(args: any): Promise<CallToolResult> {
  ...
  private async handleGetEmployerProfile(args: any): Promise<CallToolResult> {
  ...
  private async handleCreateEmployerProfile(args: any): Promise<CallToolResult> {
  ...
  private async handleUpdateEmployerProfile(args: any): Promise<CallToolResult> {
    const { id, ...updateData } = args;
  ...
  private async handleListIoTVendors(args: any): Promise<CallToolResult> {
  ...
  private async handleGetIoTVendor(args: any): Promise<CallToolResult> {
  ...
  private async handleCreateIoTVendor(args: any): Promise<CallToolResult> {
  ...
  private async handleListIoTEvents(args: any): Promise<CallToolResult> {
  ...
  private async handleGetIoTEvent(args: any): Promise<CallToolResult> {
