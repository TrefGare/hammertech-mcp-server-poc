...
export class HammerTechMCPServer {
    ...
    registerTools() {
        ...
        const withApi = (fn) => async (args) => {
            if (!this.apiClient) {
                throw new Error('HammerTech API client not configured. Set HAMMERTECH_JWT_TOKEN and HAMMERTECH_REGION.');
            }
            return fn(args);
        };
        // Connectivity check tool
        this.server.registerTool('status.ping', {
            title: 'Ping',
        ...
        this.server.registerTool('get_project', {
            title: 'Get project',
        ...
        // Workers
        this.server.registerTool('list_workers', {
            title: 'List workers',
        ...
        }, withApi(async (args) => json(await this.apiClient.listWorkers(args))));
        {
            name: 'get_worker',
                description;
            'Retrieve a specific worker by ID (per-project record connecting a Worker Profile to a Project)',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        // Worker Profiles
        {
            name: 'list_worker_profiles',
                description;
            'List worker profiles (unique individuals/people within the company) with optional filtering and pagination',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        }
        {
            name: 'get_worker_profile',
                description;
            'Retrieve a specific worker profile by ID (unique individual/person within the company)',
                inputSchema;
            {
                type: 'object',
                    properties;
                {
                    ...
                    includeConfidentialData: {
                        ...
                        'Include confidential data in response';
                    }
                }
                required: ['id'],
                ;
        ...
        }
        {
            name: 'create_worker_profile',
                description;
            'Create a new worker profile (unique individual/person within the company)',
                inputSchema;
            {
                type: 'object',
                    properties;
                {
                    ...
                    dateOfBirth: {
                        type: 'string', description;
                        'Date of birth in extended ISO 8601 format (YYYY-MM-DDThh:mm:ss), e.g. 1970-01-01T00:00:00';
                    }
        ...
        }
        {
            name: 'update_worker_profile',
                description;
            'Update an existing worker profile (unique individual/person within the company)',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        // Employers
        {
            name: 'list_employers',
                description;
            'List employers (companies/organizations associated with specific projects) with optional filtering and pagination',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        }
        {
            name: 'get_employer',
                description;
            'Retrieve a specific employer by ID (company/organization associated with a project)',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        }
        {
            name: 'create_employer',
                description;
            'Create a new employer (associate a company/organization with a project)',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        // Employer Profiles
        {
            name: 'list_employer_profiles',
                description;
            'List employer profiles (master records for companies/organizations) with optional filtering and pagination',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        }
        {
            name: 'get_employer_profile',
                description;
            'Retrieve a specific employer profile by ID (master company/organization record)',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        }
        {
            name: 'create_employer_profile',
                description;
            'Create a new employer profile (master company/organization record)',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        }
        {
            name: 'update_employer_profile',
                description;
            'Update an existing employer profile (master company/organization record)',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        // IoT Vendors
        {
            name: 'list_iot_vendors',
                description;
            'List IoT vendors (manufacturers/providers of IoT devices) with optional filtering and pagination',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        }
        {
            name: 'get_iot_vendor',
                description;
            'Retrieve a specific IoT vendor by ID (manufacturer/provider of IoT devices)',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        }
        {
            name: 'create_iot_vendor',
                description;
            'Create a new IoT vendor (manufacturer/provider of IoT devices)',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        // IoT Events
        {
            name: 'list_iot_events',
                description;
            'List IoT events with optional filtering and pagination',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        }
        {
            name: 'get_iot_event',
                description;
            'Retrieve a specific IoT event by ID',
                inputSchema;
            {
                type: 'object',
                    properties;
        ...
        }
        {
                ...
                inputSchema;
            {
                    ...
                    properties;
                {
                    projectId: {
                        type: 'string', description;
                        'Project UUID associated with the IoT Event', format;
                        'uuid';
                    }
                    eventDate: {
                        type: 'string', description;
                        'Event date/time in ISO 8601 format (YYYY-MM-DDThh:mm:ss), e.g. 2024-01-15T14:30:00. If not provided, current date/time will be used.', format;
                        'date-time';
                    }
                    iotVendorId: {
                        type: 'string', description;
                        'IoT Vendor UUID', format;
                        'uuid';
                    }
                    iotEventTypeId: {
                        type: 'string', description;
                        'IoT Event Type UUID', format;
                        'uuid';
                    }
                    locationId: {
                        type: 'string', description;
                        'Location Hierarchy UUID (optional)', format;
                        'uuid';
                    }
                    description: {
                        type: 'string', description;
                    ...
                    contentType: {
                        type: 'string', description;
                        'Content type: application/json, application/xml, or text/plain (optional)';
                    }
                    content: {
                        type: 'string', description;
                        'Content text of the event (optional)';
                    }
                    attachments: {
                        type: 'array',
                            description;
                        'File attachments as base64-encoded content (optional). Supported file types: PNG, JPEG, PDF, DOC, DOCX, XLS, XLSX',
                            items;
                        {
                            type: 'object',
                                properties;
                            {
                                fileName: {
                                    type: 'string', description;
                                    'Original filename (must have extension: .png, .jpg, .jpeg, .pdf, .doc, .docx, .xls, .xlsx)';
                                }
                                base64FileContent: {
                                    type: 'string', description;
                                ...
                                annotation: {
                                    type: 'string', description;
                                    'File annotation/notes (optional)';
                                }
                            }
        ...
        }
        {
            name: 'create_iot_event_with_image',
                description;
            'Create a new IoT event record with an uploaded image attachment. Use when an image has been uploaded in the conversation.',
                inputSchema;
            {
                type: 'object',
                    properties;
                {
                    ...
                    imageBase64: {
                        type: 'string', description;
                        'Base64-encoded image data from uploaded conversation image';
                    }
                    imageFileName: {
                        type: 'string', description;
                        'Filename for the image (e.g., "security_camera.jpg", "incident_photo.png")';
                    }
                    imageAnnotation: {
                        type: 'string', description;
                        'Optional annotation/description for the image attachment';
                    }
                }
